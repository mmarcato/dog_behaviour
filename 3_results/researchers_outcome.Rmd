---
title: "Researchers Ethogram - Outcome (GD, AD, W)"
...
dog's behavioral data considering the ethograms filled out by two researchers.
...
```{r, echo = FALSE}
dc1 <- read.csv('0_data//2_analysis//2021-05-03_Ethogram-Researchers-DC1.csv', stringsAsFactors=FALSE)
dc2 <- read.csv('0_data//2_analysis//2021-05-03_Ethogram-Researchers-DC2.csv', stringsAsFactors=FALSE)
...
## Results
Results are saved in a file (researchers_outcome.csv). Below are variable with statistically significant results. <br>
...
write.csv(vars, "0_data//3_results//researchers_outcome.csv")
