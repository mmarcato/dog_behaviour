...
```{r, echo = FALSE}
dcs <- read.csv('data//1_processed//Researchers_dcs.csv', stringsAsFactors=FALSE)
vars <- read.csv('data//1_processed//Researchers_variables.csv', stringsAsFactors=FALSE)
...
write.csv(vars,"data//2_analysis//Researchers_dcs.csv")
```
