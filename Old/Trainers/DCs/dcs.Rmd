...
```{r, echo = FALSE}
dcs <- read.csv('data//1_processed//Trainers_dcs.csv', stringsAsFactors=FALSE)
vars <- read.csv('data//1_processed//Trainers_variables.csv', stringsAsFactors=FALSE)
...
write.csv(vars, "data//2_analysis//Trainers_dcs.csv")
```
